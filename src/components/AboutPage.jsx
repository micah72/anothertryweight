  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold text-gray-900 mb-6">About SnapLicious AI</h1>
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          <p className="text-gray-600 mb-6">
            ...
            SnapLicious AI combines cutting-edge technology with nutritional science to provide personalized meal planning, inventory tracking, and dietary insights.
          </p>
          ...
          <p className="text-gray-600 mb-6">
            ...
            maintaining healthy eating habits and keeping track of their food inventory. That's why we created SnapLicious AI - 
          ...
          <p className="text-gray-600">
            We believe that healthy eating should be personalized to your unique needs and preferences. SnapLicious AI uses advanced 
