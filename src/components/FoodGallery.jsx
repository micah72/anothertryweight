...
const FoodGallery = () => {
  ...
  return (
    <div className="w-full bg-gradient-to-b from-gray-50 to-gray-100 min-h-screen py-8">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
          <div>
            <h1 className="text-3xl md:text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-blue-800 pb-1">
              My Food Journal
            </h1>
            <p className="text-gray-500 text-sm md:text-base">Track your meals and discover your nutrition patterns</p>
          </div>
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 text-center max-w-md mx-auto">
            ...
            <h3 className="text-xl font-semibold mb-3 text-gray-900">Your Food Journal Awaits</h3>
            <p className="text-gray-600 mb-6">Start by taking photos of your meals to track nutrition and build healthy habits</p>
            <button 
              onClick={handleAddPhoto}
              className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-full font-medium transition-all duration-200 shadow-md hover:shadow-lg"
            >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 md:gap-8">
            {foodItems.map((food) => (
              <div 
                ...
                className="group bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl cursor-pointer transition-all duration-300 hover:-translate-y-2"
              >
                <div className="relative h-56 overflow-hidden">
                  <img 
                    ...
                    loading="lazy"
                  />
                  <div className="absolute top-3 right-3 bg-white bg-opacity-90 text-blue-600 font-semibold text-sm px-3 py-1 rounded-full shadow-sm">
                    {food.calories} cal
                  </div>
                </div>
                <div className="p-4">
                  <h3 className="text-xl font-medium text-gray-900 mb-1 truncate">{food.foodName}</h3>
            ...
            <div 
              onClick={handleAddPhoto}
              className="group bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl overflow-hidden border-2 border-dashed border-blue-300 cursor-pointer transition-all duration-300 hover:shadow-xl hover:border-blue-500 flex items-center justify-center h-72"
            >
              <div className="text-center p-6 transform transition-transform duration-300 group-hover:scale-105">
                <div className="w-14 h-14 rounded-full bg-blue-100 border-4 border-white shadow-md flex items-center justify-center text-blue-600 mx-auto mb-4 group-hover:bg-blue-200 transition-colors duration-300">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
                  </svg>
                </div>
                <p className="text-blue-800 font-medium text-lg mb-2">Add New Food Photo</p>
                <p className="text-blue-600 text-sm">Capture your meal to track nutrition</p>
              </div>
            </div>
          </div>
        )}
      ...
      {selectedFood && !isEditing && (
        <div className="fixed inset-0 bg-black bg-opacity-60 backdrop-blur-sm flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-xl max-w-md w-full max-h-[90vh] overflow-hidden shadow-xl">
            <div className="relative">
              ...
              <div className="absolute bottom-0 left-0 p-4 w-full">
                <h2 className="text-xl font-bold text-white">{selectedFood.foodName}</h2>
              ...
              <button 
                ...
                className="absolute top-2 right-2 bg-white/10 backdrop-blur-sm text-white hover:bg-white/20 rounded-full p-1.5 transition-all duration-200"
              >
